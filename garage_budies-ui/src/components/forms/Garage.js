                                    ...
                                    <Box sx={{mt: 1}}>
                                        ...
                                        <Form>
                                            ...
                                            <Stack spacing={2} direction='column'>
                                                <TextInputComponent error={props.touched.companyCode && !!props.errors.companyCode}
                                                                    name="companyCode"
                                                                    label="Company code"
                                                                    margin="normal"
                                                                    fullWidth
                                                ...
                                                <TextInputComponent error={props.touched.vatCode && !!props.errors.vatCode}
                                                                    ...
                                                                    label="VAT code"
                                                ></TextInputComponent>
                                                <TextInputComponent error={props.touched.companyName && !!props.errors.companyName}
                                                                    name="companyName"
                                                                    label="Company name"
                                                ></TextInputComponent>
                                                ...
                                                <TextInputComponent error={props.touched.town && !!props.errors.town}
                                                                    ...
                                                                    label="Town"
                                                ></TextInputComponent>
                                                <TextInputComponent error={props.touched.numberOfWorkPlaces && !!props.errors.numberOfWorkPlaces}
                                                                    name="numberOfWorkPlaces"
                                                                    label="Number of work places"
                                                ></TextInputComponent>
                                                <TextInputComponent error={props.touched.companyDescription && !!props.errors.companyDescription}
